 ...
 */
public class RadialBargraphBlockIndicator extends AbstractBlockIndicator  implements Serializable {

	private transient RadialBargraph gauge = null;
  ...
  public ControlProperties getDefaultProperties() {
    ...
    def.setPropertyValue ( "Name", "RadialBargraph#"+instancesCount );
    def.setPropertyValue ( "componentClassName", "RadialBargraphBlockIndicator" );
    def.setPropertyValue ( "Title", "RadialBargraphTitle" );
  ...
  public RadialBargraphBlockIndicator ( ControlProperties uiProperties ) {
    super(uiProperties);
	...
	public RadialBargraphBlockIndicator () {
