 ...
 */
public class LinearBargraphBlockIndicator extends AbstractBlockIndicator implements Serializable {

	private transient LinearBargraph gauge = null;
  ...
  public ControlProperties getDefaultProperties() {
    ...
    def.setPropertyValue ( "Name", "LinearBargraph#"+instancesCount );
    def.setPropertyValue ( "componentClassName", "LinearBargraphBlockIndicator" );
    def.setPropertyValue ( "Title", "LinearBargraphTitle" );
  ...
  public LinearBargraphBlockIndicator ( ControlProperties uiProperties ) {
	...
	public LinearBargraphBlockIndicator () {
