 ...
 */
public class DisplayCircularBlockIndicator extends AbstractBlockIndicator implements Serializable {

	private transient DisplayCircular gauge = null;
  ...
  public ControlProperties getDefaultProperties() {
    ...
    def.setPropertyValue ( "Name", "DisplayCircular#"+instancesCount );
    def.setPropertyValue ( "componentClassName", "DisplayCircularBlockIndicator" );
    def.setPropertyValue ( "Title", "DisplayCircularTitle" );
  ...
  public DisplayCircularBlockIndicator ( ControlProperties uiProperties ) {
    super(uiProperties);
...
//		gauge.setMaxValue(1000);
	...
	public DisplayCircularBlockIndicator () {
