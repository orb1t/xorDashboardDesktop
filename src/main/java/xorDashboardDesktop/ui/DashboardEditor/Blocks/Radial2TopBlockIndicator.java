 ...
 */
public class Radial2TopBlockIndicator extends AbstractBlockIndicator implements Serializable {

	private transient Radial2Top gauge = null;
  ...
  public ControlProperties getDefaultProperties() {
    ...
    def.setPropertyValue ( "Name", "Radial2Top#"+instancesCount );
    def.setPropertyValue ( "componentClassName", "Radial2TopBlockIndicator" );
    def.setPropertyValue ( "Title", "Radial2TopTitle" );
  ...
  public Radial2TopBlockIndicator ( ControlProperties uiProperties ) {
    super(uiProperties);
	...
	public Radial2TopBlockIndicator () {
