 ...
 */
public class Radial1VerticalBlockIndicator extends AbstractBlockIndicator implements Serializable {

	private transient Radial1Vertical gauge = null;
  ...
  public ControlProperties getDefaultProperties() {
    ...
    def.setPropertyValue ( "Name", "Radial1Vertical#"+instancesCount );
    def.setPropertyValue ( "componentClassName", "Radial1VerticalBlockIndicator" );
    def.setPropertyValue ( "Title", "Radial1VerticalTitle" );
  ...
  public Radial1VerticalBlockIndicator ( ControlProperties uiProperties ) {
    super(uiProperties);
	...
	public Radial1VerticalBlockIndicator () {
