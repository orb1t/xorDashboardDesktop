 ...
 */
public class LinearBlockIndicator extends AbstractBlockIndicator implements Serializable {

	private transient Linear gauge = null;
  ...
  public ControlProperties getDefaultProperties() {
    ...
    def.setPropertyValue ( "Name", "Linear#"+instancesCount );
    def.setPropertyValue ( "componentClassName", "LinearBlockIndicator" );
    def.setPropertyValue ( "Title", "LinearTitle" );
  ...
  public LinearBlockIndicator ( ControlProperties uiProperties ) {
    super(uiProperties);
